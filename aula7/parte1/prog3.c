...
// for system call to be called at a frequency of 1Hz:
volatile int skip = 0; // just call the system call after 2 interruptions,
                       // which means to skip the call in 1 interruption
